...
class BinarySearchTree(object):
    ...
    def size(self):
        """
        # nodes in the BST (Worst Case: O(1)/Balanced Tree: O(1))
        """
        return self._size(self.root)

    def is_empty(self):
        """
        True if empty, False otherwise (Worst Case: O(1)/Balanced Tree: O(1))
        """
        return self.size() == 0
    ...
    def get(self, key):
        """
        (Worst Case: O(N)/Balanced Tree: O(lg N))
        """
        return self._get(key, self.root)

    def contains(self, key):
        """
        True if the BST contains 'key' (Worst Case: O(N)/Balanced Tree: O(lg N))
        """
    ...
    def _min_node(self):
        """
        node with minimum key in the BST
        """
        min_node = self.root
    ...
    def select_key(self, rank):
        """
        Return the key with rank equal to 'rank' O(N)/O(lg N)
        """
    ...
    def rank(self, key):
        """
        Return the number of keys less than a given 'key'. O(N)/O(lg N)
        """
    ...
    def delete_min(self):
        """
        Remove the key-value pair with the smallest key. O(N)/O(lg N)
        """
    ...
    def delete_max(self):
        """
        Remove the key-value pair with the largest key. O(N)/O(lg N)
        """
    ...
    def keys(self):
        """
        Return all of the keys in the BST in aschending order O(N)/O(N)
        """
        keys = []
